...
{
    public partial class DB_A3E3FF_scampusMaster2020Context : DbContext
    {
        public DB_A3E3FF_scampusMaster2020Context()
        {
        }

        public DB_A3E3FF_scampusMaster2020Context(DbContextOptions<DB_A3E3FF_scampusMaster2020Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=sql6009.site4now.net;Database=DB_A3E3FF_scampusMaster2020;User Id=DB_A3E3FF_scampusMaster2020_admin;Password=Admin@5264740;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ConfigurationMaster>(entity =>
            {
                entity.HasKey(e => e.ConfigId)
                    .HasName("PK__Configur__C3BC335C3ED705E4");
            ...
            modelBuilder.Entity<InConfiguration>(entity =>
            {
                entity.HasKey(e => e.ConfId)
                    .HasName("PK__In_Confi__677699634EF35330");
            ...
            modelBuilder.Entity<TblDepatment>(entity =>
            {
                entity.HasKey(e => e.DepartmentId)
                    .HasName("PK__tbl_Depa__63E613626715D11A");
            ...
            modelBuilder.Entity<TblEmployee>(entity =>
            {
                entity.HasKey(e => e.EmployeeId)
                    .HasName("PK__tbl_Empl__CBA14F484FCE4402");
